...
//         if (gameCards[i].classList.includes("hiden")) {
//             console.log(hi);
//         } else {
//             return
//         }
...
//     let removeHiden = document.getElementsByClassName("flip-card-back")
//     removeHiden.classList.remove("hiden")
//     game()
//     console.log("start");

// }

// // const startOver = document.getElementsByClassName("StartOverButton")
// document.getElementsByClassName("StartOverButton").addEventListener("click", restartGame)